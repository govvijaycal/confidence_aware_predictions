...
L5KIT_TRAIN = [ f"{datadir}/l5kit_train_{x}.record" for x in range(307) ]
L5KIT_VAL   = [ f"{datadir}/l5kit_trainval_{x}.record" for x in range(101) ]
L5KIT_TEST  = [ f"{datadir}/l5kit_val_{x}.record" for x in range(101) ]
